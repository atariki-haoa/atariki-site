...
import { calculateQuoteEstimate } from '../services/quoteCalculator.js';
import { DEFAULT_LOCALE, isSupportedLocale, type Locale } from '../types/locale.js';
...
router.post('/', async (req, res) => {
  ...
  try {
    const { name, phone, email, budget, technology, timeline, locale }: QuoteRequestBody = req.body;
